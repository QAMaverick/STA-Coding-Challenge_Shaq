...
namespace STACodingChallenge
{
    ...
    public class InvalidResults
    {
        ...
        public void invalidResults_OneInvLocal_OneValidLocal()
        {
            ...
            driver.FindElement(By.Id("InputTo")).SendKeys("Leicester Square ");
            Thread.Sleep(1000);
            ...
            string invJourInnerText = invalidJourney.Text;
            Assert.That(invJourInnerText, Is.EqualTo("Journey planner could not find any results to your search. Please try again"));
        }
